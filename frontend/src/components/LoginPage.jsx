      ...
      <div className="relative z-10 w-full max-w-[410px] sm:max-w-[430px] md:max-w-[450px] my-auto">
        ...
        <div className="bg-white/98 backdrop-blur-2xl border border-slate-200/90 rounded-3xl p-5 sm:p-7 md:p-8 shadow-2xl shadow-black/60 ring-1 ring-slate-900/5">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
            {/* Username Input (Permanently Locked to Jatin Panchal) */}
            <div className="space-y-1.5 text-left">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  tabIndex={-1}
                  aria-readonly="true"
                  className="w-full pl-10 pr-10 py-2.5 sm:py-3 bg-slate-100/80 border border-slate-300 rounded-xl text-slate-900 text-xs sm:text-sm font-bold cursor-not-allowed select-none shadow-inner"
                />
